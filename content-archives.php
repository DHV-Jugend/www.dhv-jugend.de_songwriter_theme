...
<?php if ( $songwriter_options_db['songwriter_display_meta_post_entry'] != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php if ( $songwriter_options_db['songwriter_content_archives'] != 'Content' ) { ?>
<?php the_excerpt(); ?>
<?php } else { ?>
...
<?php if ( $songwriter_options_db['songwriter_display_meta_post_entry'] != 'Hide' && has_category() ) { ?>
        <div class="post-info">
